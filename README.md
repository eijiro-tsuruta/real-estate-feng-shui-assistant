...
3メニューは入力とAIの役割を混在させません。

- 建物間取り風水：間取り図だけを使い、建物の中心、玄関、各室、水回りなど建物全体の配置を扱います。
- お部屋の風水：診断する一室の種別を選び、その部屋の北・東・南・西の写真だけを使います。建物全体や写真に写っていない水回りは推測せず、家具、観葉植物、照明、鏡、収納、色、素材、動線を提案します。4方向完了後に「アドバイスを作成」ボタンを表示します。
- 壁のイメージ：対象の壁写真と、壁紙画像または希望する色・雰囲気だけを扱います。
