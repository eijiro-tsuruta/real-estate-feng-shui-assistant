  ...
  return (
    <main>
      <header className="site-header">
        <Link className="brand" href="/" aria-label="住まいの方位レポート ホーム">
      ...
      <section className="hero">
        <div className="product-free-note"><span>FREE</span> 登録不要・期間限定ですべての機能を無料でお試しいただけます</div>
      ...
      <section className="workspace" aria-labelledby="form-title">
        ...
        {!liveAnalysisEnabled && (
          <aside className="demo-only-notice">
            <strong>現在、AI解析の接続準備中です</strong>
            <p>
              「サンプルレポートを見る」から、完成イメージをご確認いただけます。
            </p>
          </aside>
        )}
      ...
      {result && (
        <ReportResult
          ref={resultRef}
          result={result}
          imageUrl={result.demo ? "/sample-floorplan.png" : preview}
        />
      )}
